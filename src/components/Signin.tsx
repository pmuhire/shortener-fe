...
const Signin = () => {
    ...
    async function shorten(userData: userData) {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        const token= await shorten(userData);
            ...
            <div className="form-container">
                ...
                <form className="form" onSubmit={e => handleSubmit(e)}>
                    <div className="form-group">
                        ...
                        <input required={true} onChange={handleChange} value={userData.username} name="username" placeholder="Enter your username" id="username" type="text" />
                    </div>

                    <div className="form-group">
                        <label htmlFor="password">Password</label>
                        <input required={true} onChange={handleChange} value={userData.password} name="password" placeholder="Enter your password" id="password" type="password" />
                    </div>
